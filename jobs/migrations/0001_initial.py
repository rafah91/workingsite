# Generated by Django 4.2 on 2023-10-22 19:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_count', models.IntegerField(max_length=10000, verbose_name='Job Count')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=120, verbose_name='Name')),
                ('logo', models.ImageField(upload_to='campany', verbose_name='Logo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lacation', models.CharField(max_length=120, verbose_name='Location')),
                ('salary', models.FloatField(verbose_name='Salary')),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Created at')),
                ('vacancy', models.IntegerField(verbose_name='Vacancy')),
                ('nature', models.CharField(choices=[('Full Time', 'Full Time'), ('Part Time', 'Part Time'), ('Remote', 'Remote'), ('Freelance', 'Freelance')], max_length=20, verbose_name='Nature')),
                ...
                ('slug', models.SlugField(blank=True, null=True)),
                ('agency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='job_company', to='jobs.company', verbose_name='Agency')),
